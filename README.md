...
<p>Don't want to create all the chat ? You can deploy on Heroku the complete chat on the branch  : <a href="https://github.com/R3tr093/Heroku-socket/tree/takeaway" target="_blank">takeaway </a></p>
